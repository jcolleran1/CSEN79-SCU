...
namespace coen79_lab7
{
    ...
    //This function is the constructor with a name
    ...
    //This function is the copy constructor with other company
    ...
    //PRECONDITION: The length of a given product is more than zero
    //POSTCONDITION: Inserts a given product to a company
    ...
    //PRECONDITION: The length of a given product is more than zero
    //POSTCONDITION: Deletes a given product from a company
